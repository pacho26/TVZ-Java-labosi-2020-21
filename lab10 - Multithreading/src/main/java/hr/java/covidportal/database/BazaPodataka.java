...
public class BazaPodataka {
     ...
     */
    public synchronized static Connection otvaranjeVeze() throws SQLException {
     ...
     * @throws SQLException baca se u slučaju neuspješnog otvaranja/zatvaranja veze ili neuspješnog izvršavanja upita
     */
    private static Zupanija dohvacanjeZupanijePremaId (Long identifikator) throws SQLException {
        Connection veza = otvaranjeVeze();
    ...
    public static Integer dohvacanjeUkupnogBrojaBolesti() throws SQLException {
        Connection veza = otvaranjeVeze();
        Integer broj = 0;

        PreparedStatement upit = veza.prepareStatement("SELECT COUNT(*) AS broj FROM BOLEST WHERE VIRUS = 0;");
        ResultSet resultSet = upit.executeQuery();
        resultSet.next();
