...
public class Osoba implements Serializable {
    ...
    private String korisnickoIme;//--------------------------------1. ZADATAK--------------------------------
    ...
    public static class Builder{
        ...
        public Builder withKorisnickoIme(String korisnickoIme){     //-------------------1. ZADATAK---------------------
        ...
        public Osoba build(){
            ...
            osoba.korisnickoIme = this.korisnickoIme;   //--------------------------1. ZADATAK--------------------------
    ...
    public String getKorisnickoIme() {  //----------------------------------1. ZADATAK----------------------------------
